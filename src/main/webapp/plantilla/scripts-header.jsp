...
<!-- DataTables -->
<link rel="stylesheet" href="${url_aplicacion}/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
<link rel="stylesheet" href="${url_aplicacion}/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
<!-- SweetAlert2 -->
